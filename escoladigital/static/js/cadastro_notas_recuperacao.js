 $(document).ready(function(){
      ...
      //Ver uma forma de usar uma lista propria para essa consulta de disciplinas(Mto estranho)
      ...
      $("#filtros").on('change','select.busca', function(){
        ...
        $("#divAluno").children().remove();
          if(validarCamposBusca()){
            $("#divAluno").load("/rendimento/turma/recuperacao/"+$("#turma").val()+"/disciplina/"+$("#disciplinas").val(), function(){
      ...
      $("#divAluno").on('click','button', function(){
